...
<form id="auth-form">
  ...
  ${isRegisterMode ? `
    <div class="g-recaptcha"
         data-sitekey="6LdOxgAtAAAAACwHs4SZNwYqcIv4RSitlGgRYwDn"
...
// reCAPTCHA
if (isRegisterMode) {
  const recaptchaEl = document.getElementById("recaptcha-token");
  ...
  body.recaptcha = recaptchaEl.value;
}
...
if (isRegisterMode) {
  ...
  errorEl.textContent = "Registration successful! Check your email for confirmation.";
  return;
}
